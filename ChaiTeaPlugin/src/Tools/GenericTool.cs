...
namespace ChaiTea
{
    public class GenericTool : GenericObject
    {
        ...
        public int GetNumHapticPoints()
        {
            return GenericTool_GetNumHapticPoints(ptr);
        }
        ...
        [DllImport("ChaiTeaLib", EntryPoint = "GenericTool_GetNumHapticPoints")]
        protected static extern int GenericTool_GetNumHapticPoints(IntPtr pTool);

        [DllImport("ChaiTeaLib", EntryPoint = "GenericTool_GetNumHapticPoints")]
        protected static extern IntPtr GenericTool_GetHapticPoint(IntPtr pTool, int hapticPointIndex);
    }
}
