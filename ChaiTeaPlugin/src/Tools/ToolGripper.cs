...
namespace ChaiTea
{
    ...
    {
        public ToolGripper(World world, int deviceIndex) : base(ToolGripper_Create(world.Pointer,deviceIndex))
        {
            world.AddChild(this);
        }
        ...
        public new GripperPose GetDevicePosition()
        {
            return ToolGripper_GetDevicePosition(ptr);
        }

        public new Quaternion GetRotation()
        {
        ...
        protected static extern IntPtr ToolGripper_Create(IntPtr pWorldObject, int deviceIndex);
